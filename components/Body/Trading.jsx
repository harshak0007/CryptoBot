...
const Trading = ({
    ...
    loader,
    setLoader,
    setActiveComponent, notifyError, notifySuccess }) => {
    ...
    useEffect(() => {
        if (active) {
            const yourFunction = () => {
                ...
                console.log("Function called every 1 minite")
            }
    ...
    useEffect(() => {
        const listTransaction = JSON.parse(localStorage.getItem("LIVE_TRANSACTION"));
        setLiveTransaction(listTransaction)
    }, [tradingCount, length])
                        ...
                        <div className='techwave_fn_user_profile'>
                            <div className='user__profile'>
                                <div className='user_avatar'>
                                    <img src={activeNetwork?.image || "img/crypto.png"} alt=''></img>
                                </div>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div className='item'>
                                                ...
                                                <h3 className='title'>
                                                    {activeNetwork?.walletAddress == undefined ? "select" : shortenAddress(activeNetwork?.walletAddress)}
                                        ...
                                        <li>
                                            <div className='item'>
                                                ...
                                                <h3 className='title'>
                                                    {activeNetwork?.privateKey == undefined ? "select" : shortenAddress(activeNetwork?.privateKey)}
                                        ...
                                        <li>
                                            <div className='item'>
                                                ...
                                                <h3 className='title'>
                                                    {activeNetwork?.rpcUrl == undefined ? "select" : shortenAddress(activeNetwork?.rpcUrl)}
                            ...
                            <div>
                                {
                                    userMembership !== "notMember" ? (
                                        <>
                                            {
                                                active ? (<a onClick={() => stopTrading()} className='techwave_fn_button'>Stop Bot</a>) : (
                                                    <a onClick={() => { trading(activeNetwork, tradeToken), setActive(true), notifySuccess("Transaction Started....") }} className='techwave_fn_button'>Start Trading</a>

                                                )
                                            }
                                        </>
                                    ) : <a onClick={() => { setActiveComponent("Pricing") }} className='techwave_fn_button'>Buy Membership</a>
                                }
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div className='pricing__item'>
                                                        <div className='pricing__item_holder'>
                                                            <div className='pricing__item__heading'>
                                                                <h2 className='title'>Live Transactions...</h2>
                                                    ...
                                                    liveTransaction.map((transaction, index) => (
                                                        <div key={index} className='pricing__fields'>
                                                            <div className='new_flex'>
                                                                ...
                                                                <div className='item_col'>
                                                                    <span onClick={() => navigator.clipboard.writeText(transaction.transactionHash)} className='heading_text'>
