                                ...
                                <div className='pricing__tab active'>
                                            ...
                                            <div className='pricing__item_holder'>
                                                <div className='pricing__item__header'>
                                                    ...
                                                    <p className=' purchase'>
                                                        <a className='techwave_fn_button' onClick={() => { }}>
                                                            Buy Personal
                                                        </a>
                                                    </p>
                                                </div>
                                                ...
                                                <div className='pricing__item_list'>
                                                    {["Crypto", "Dh Tokens", "Running Bot", "Matic Trading", "Any Exchange Trade", "Unlimited data"].map((item, index) => (
                                                        <div className='pricing__item_list_item'>
                                                            ...
                                                            <p className='desc'>20,{index + 1}00</p> </div>
                                                    ))}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className='pricing__content'>
                                        <div className='pricing__header'>
                                            <div className='item_row'>
                                                ...
                                                <div className='item_col'>
                                                    ...
                                                    <p className='purchase'>
                                                        <a onClick={() => { buyMemberShip("Personal", 0.0001) }} className='techwave_fn_button'>
                                                            Buy Personal
                                                        </a>
                                                    </p>
                                                </div>
                                                ...
                                                <div className='item_col'>
                                                    ...
                                                    <p className='purchase'>
                                                        <a onClick={() => { buyMemberShip("Premium", 0.0001) }} className='techwave_fn_button'>
                                                            Buy Premium
                                                        </a>
                                                    </p>
                                                </div>
                                                ...
                                                <div className='item_col'>
                                                    ...
                                                    <p className='purchase'>
                                                        <a onClick={() => { buyMemberShip("Enterprice", 0.0001) }} className='techwave_fn_button'>
                                                            Buy Enterprice
                                                        </a>
                                                    </p>
                                                </div>
                                        ...
                                        <div className='pricing__heading'>
                                            <div className='item'>
                                                <span className='title'>Main Features</span></div>
